...
export default function AISidebar() {
  ...
  return (
    <div className="w-[300px] h-full bg-[#E6E3DF] border-l border-[#CFCCC8] flex flex-col">
      ...
      {/* 对话区域 */}
      <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-[#E8E5E0]">
      ...
      <div className="p-4 border-t border-[#CFCCC8]">
        <div className="relative">
          <input
            ...
            placeholder="向AI助手提问..."
            className="w-full px-4 py-2 pr-10 text-sm bg-white border border-[#E8E5E0] rounded-md focus:outline-none focus:ring-2 focus:ring-[#111111] focus:border-transparent"
          />
          <button className="absolute right-2 top-1/2 -translate-y-1/2 p-1 hover:bg-[#E8E5E0] rounded transition-colors">
